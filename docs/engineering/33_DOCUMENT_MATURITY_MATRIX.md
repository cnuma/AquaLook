...
| sécurité | 23 | D3 | registre de risques | suppression des secrets dans les logs et procédures testées |
...
1. affichage et tactile ;
2. SD, ressources statiques et manifeste ;
3. réseau, états et timeouts ;
4. modèle V4 et météo ;
5. tests automatisés des contrats D4.
